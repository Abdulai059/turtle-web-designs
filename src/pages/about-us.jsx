  ...
  return (
    <>
      ...
      <div className="mx-auto mb-16 max-w-3xl text-center">
        ...
        >
          Our journey beginsshaping the future of businesses online.
        </motion.p>
      </div>
    </>
  );
    ...
    <>
      ...
      <div ref={aboutRef} className="relative mx-auto mb-20">
        <div className="grid gap-16 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              To empower businesses with innovative digital solutions that fuel
              growth, enhance customer experiences, and create lasting value in
          ...
          >
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              To become a globally recognized leader in delivering
              transformative digital experiences, known for excellence,
              innovation, and a relentless commitment to client success.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            We are a passionate team of digital experts committed to delivering
            exceptional solutions that help businesses thrive online. By
            combining innovation, creativity, and quality, we’ve become a
            trusted partner for organizations seeking growth in today’s
            digital-first world.
          </p>
        </motion.div>
      </div>
...
const timeline = [
  {
    ...
    title: "Founded",
    description:
      "Our journey began with a mission to empower businesses through modern web design and smart automation.",
  },
  {
    year: "2026",
    title: "First 50 Clients",
    description:
      "Reached our first major milestone by delivering innovative digital solutions to 50+ businesses.",
  },
  {
    year: "2027",
    title: "Expanding Services",
    description:
      "Introduced advanced automation, chatbot integrations, and global-ready solutions for clients.",
  },
  {
    year: "2029",
    title: "Global Recognition",
    description:
      "Recognized as a trusted digital partner for organizations worldwide, delivering scalable, impactful solutions.",
  },
];
