...
const plans = [
  {
    ...
    description:
      "An affordable entry point for individuals and small businesses to go digital.",
    features: [
  ...
  },
  {
    ...
    description: "Everything you need to grow and scale your online presence.",
    features: [
  ...
  },
  {
    ...
    description:
      "Tailored digital solutions for large businesses and organizations.",
    features: [
...
export default function SimplePricing() {
  ...
  return (
    <div className="not-prose relative flex w-full flex-col gap-16 overflow-hidden px-4 py-25 text-center sm:px-8 sm:pt-30">
      <Header />
      ...
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <PricingNav frequency={frequency} setFrequency={setFrequency} />
...
export function PricingNav({ frequency, setFrequency }) {
  return (
    <>
      <motion.div
