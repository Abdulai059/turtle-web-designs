...
const defaultTestimonials = [
  {
    text: "Turtle Web Designs transformed our online presence. Clean, modern, and fast-loading—exactly what we needed.",
  ...
  {
    text: "I love how seamless the design process was. They understood my vision and delivered beyond expectations.",
    imageSrc: "https://i.pravatar.cc",
    name: "Jennifer Mensah",
    username: "@jenny.codes",
    role: "Creative Director",
  },
  {
    text: "Our startup’s website was live in record time. Professional service and beautiful results. Highly recommended!",
    imageSrc: "https://i.pravatar.cc",
    name: "Kwame Boateng",
    username: "@kwame_dev",
  ...
  {
    text: "Working with Turtle Web Designs felt effortless. Their reusable components saved us so much development time.",
    imageSrc: "https://i.pravatar.cc",
    name: "Aisha Karim",
...
export default function TestimonialsCarousel({
  ...
  subtitle = "From sleek designs to smooth user experiences, Turtle Web Designs helps brands stand out and grow online.",
  autoplaySpeed = 3000,
  className,
}) {
