...
export default function AboutUs() {
  const aboutData = {
    title: "About Us",
    subtitle:
      "Building the future of businesses with modern web design and smart automation.",
    mission:
      "Our mission is to deliver high-quality, scalable web solutions that help businesses grow and thrive in the digital era.",
    vision:
      "We envision a world where building professional, impactful websites is accessible to every business, regardless of their size, resources, or technical expertise.",
